...
import type { FormattedRepository, Repository } from '../types.js';
...
/**
 * Format date to display how long ago it was
 */
...
/**
 * Format a value with the appropriate singular/plural unit
 */
...
/**
 * Check if a repository is considered inactive based on its last update
 */
 ...
 */
export function formatRepositoryInfo(repo: Repository, commitCount: number): FormattedRepository {
...
/**
 * Format repository name with appropriate highlighting based on status
 */
...
/**
 * Create a selection prompt for repositories
 */
export async function promptRepositorySelection(repositories: FormattedRepository[]): Promise<FormattedRepository[]> {
 ...
 */
export async function confirmDeletion(repositories: FormattedRepository[]): Promise<boolean> {
...
/**
 * Display warning message before deletion
 */
...
/**
 * Display a summary of deleted repositories
 */
export function displayDeletionSummary(repositories: FormattedRepository[]): void {
